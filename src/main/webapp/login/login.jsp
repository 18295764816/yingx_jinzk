            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${path}/admin/LoginAction" method="post" class="login-form" id="loginForm">
                            <span id="msgDiv">${sessionScope.message}</span>
...
<%--                                <img id="captchaImage" style="height: 48px" class="captchaImage" src="${path}/admin/ImageAction">--%>
<%--                                <input style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="test" name="str" id="form-code">--%>
                                    <input type="text" name="str" style="width: 100px"><a id="vcodeImgBtn" name="change_code_link" class="code_picww" href=""${pageContext.request.contextPath}/admin/ImageAction""><img type="image" src="${pageContext.request.contextPath}/admin/ImageAction" id="img-vcode" onclick="changeImage()"></a>
                            </div>
